<template>
  <div class="modal-content-container">
    <div>
      ...
      <p>
        A series of custom components I'm developing for a few apps that I'm
        working on. This page documents usages of the components, and allows you
        to change some settings on the components.
      </p>
