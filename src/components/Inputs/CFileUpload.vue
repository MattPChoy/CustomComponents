<template>
  <input-component-wrapper>
    <template #input>
      <div v-if="draggable" class="file-draggable-container" :class="{'drag': isDragging, 'input-disabled': disabled }"
      ...
      <input v-show="!draggable" type="file" @input="onFilesSelected" ref="fileInput" :multiple="multiple" :disabled="disabled">
    </template>
  </input-component-wrapper>
</template>
